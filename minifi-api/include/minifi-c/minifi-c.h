...
MinifiStatus MinifiProcessContextGetSslContextService(MinifiProcessContext* process_context, MinifiStringView controller_service_name, MinifiSslContextService** ssl_context_service);
...
void MinifiProcessSessionGetFlowFileAttributes(MinifiProcessSession* session, MinifiFlowFile* flowfile, void(*cb)(void* user_ctx, MinifiStringView attribute_name, MinifiStringView attribute_value), void* user_ctx);
