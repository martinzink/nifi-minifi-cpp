...
function(use_openssl SOURCE_DIR BINARY_DIR)
    ...
    ExternalProject_Add(
            ...
            CONFIGURE_COMMAND ${OSSL_CONFIGURE} ${OPENSSL_SHARED_FLAG} ${OPENSSL_EXTRA_FLAGS} "--prefix=${OPENSSL_BIN_DIR}" "--openssldir=${OPENSSL_BIN_DIR}" "--libdir=${LIBDIR}"
    ...
    set(FIPS_MODULE "${OPENSSL_FIPS_BIN_DIR}/${LIBDIR}/ossl-modules/fips${CMAKE_SHARED_LIBRARY_SUFFIX}")
    ...
    ExternalProject_Add(
            ...
            BUILD_IN_SOURCE TRUE
            CONFIGURE_COMMAND ${OSSL_CONFIGURE} ${OPENSSL_SHARED_FLAG} ${OPENSSL_FIPS_EXTRA_FLAGS} "--prefix=${OPENSSL_FIPS_BIN_DIR}" "--openssldir=${OPENSSL_FIPS_BIN_DIR}" "--libdir=${LIBDIR}"
