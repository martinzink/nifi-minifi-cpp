...
set(RDKAFKA_INSTALL "OFF" CACHE STRING "" FORCE)
...
set(PATCH_FILE_3 "${CMAKE_SOURCE_DIR}/thirdparty/librdkafka/0003-added_RDKAFKA_INSTALL_option_to_cmake.patch")
...
FetchContent_Declare(libkafka
        URL https://github.com/confluentinc/librdkafka/archive/refs/tags/v2.11.1.tar.gz
        URL_HASH SHA256=a2c87186b081e2705bb7d5338d5a01bc88d43273619b372ccb7bb0d264d0ca9f
        SYSTEM
        PATCH_COMMAND "${PC}"
)
...
get_target_property(ZSTD_INCLUDE_DIRS zstd INCLUDE_DIRECTORIES)
