...
set(ENABLE_LZ4_EXT "OFF" CACHE STRING "" FORCE)
set(WITH_LZ4 "ON" CACHE STRING "" FORCE)
...
set(ENABLE_DEVEL "OFF" CACHE STRING "" FORCE)
set(WITH_DEVEL "OFF" CACHE STRING "" FORCE)
...
FetchContent_Declare(libkafka
        ...
        URL_HASH SHA256=75f59a2d948276504afb25bcb5713a943785a413b84f9099d324d26b2021f758
        PATCH_COMMAND "${PC}"
        INSTALL_COMMAND ""
)
...
target_link_libraries(rdkafka INTERFACE zstd::zstd)
