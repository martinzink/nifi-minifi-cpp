...
function(use_bundled_rocksdb SOURCE_DIR BINARY_DIR)
    ...
    if (NOT WIN32)
        add_dependencies(rocksdb-external ZLIB::ZLIB BZip2::BZip2 zstd::zstd lz4_static)
    endif()
    ...
    if(WIN32)
        ...
        target_link_libraries(RocksDB::RocksDB INTERFACE ZLIB::ZLIB BZip2::BZip2 zstd::zstd lz4_static)
    endif()
