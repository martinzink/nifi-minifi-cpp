...
if __name__ == '__main__':
    with tempfile.TemporaryDirectory() as cmake_cache_dir:
        ...
        parser.add_argument('--compiler_override', help="Skips the installation of the default compiler "
                                                        " and appends this to the cmake options")
        ...
        minifi_options = parse_minifi_options(str(path.as_posix()), cmake_overrides, package_manager, cmake_cache_dir)
