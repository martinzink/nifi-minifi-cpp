...
TEST_CASE("file_clock to system_clock conversion tests") {
...

  {
    ...
    CHECK(time_point_cast<LeastPreciseDurationType>(system_now) == time_point_cast<LeastPreciseDurationType>(double_converted_system_now));
  }

  {
    ...
    CHECK(time_point_cast<LeastPreciseDurationType>(file_now) == time_point_cast<LeastPreciseDurationType>(double_converted_file_now));
  }
}
