...
| JNI                              | **NiFi Processors**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | -DMINIFI_JNI=ON              |
...
```
~/Development/code/apache/nifi-minifi-cpp/build
$ cmake -DMINIFI_JNI=OFF -DENABLE_AWS=ON -DENABLE_LIBRDKAFKA=ON -DENABLE_MQTT=ON -DENABLE_AZURE=ON -DENABLE_SQL=ON -DDOCKER_BUILD_ONLY=ON ..
$ make docker
```
