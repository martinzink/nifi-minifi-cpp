...
A subset of the Apache NiFi [Expression Language](docs/EXPRESSIONS.md) is supported.
...
|---------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Base**      | [AppendHostInfo](docs/PROCESSORS.md#appendhostinfo)<br/>[AttributesToJSON](docs/PROCESSORS.md#attributestojson)<br/>[DefragmentText](docs/PROCESSORS.md#defragmenttext)<br/>[ExecuteProcess](docs/PROCESSORS.md#executeprocess)<br/>[ExtractText](docs/PROCESSORS.md#extracttext)<br/>[FetchFile](docs/PROCESSORS.md#fetchfile)<br/>[GenerateFlowFile](docs/PROCESSORS.md#generateflowfile)<br/>[GetFile](docs/PROCESSORS.md#getfile)<br/>[GetTCP](docs/PROCESSORS.md#gettcp)<br/>[HashContent](docs/PROCESSORS.md#hashcontent)<br/>[InvokeHTTP](docs/PROCESSORS.md#invokehttp)<br/>[ListenSyslog](docs/PROCESSORS.md#listensyslog)<br/>[ListenTCP](docs/PROCESSORS.md#listentcp)<br/>[ListenUDP](docs/PROCESSORS.md#listenudp)<br/>[ListFile](docs/PROCESSORS.md#listfile)<br/>[LogAttribute](docs/PROCESSORS.md#logattribute)<br/>[PutFile](docs/PROCESSORS.md#putfile)<br/>[PutTCP](docs/PROCESSORS.md#puttcp)<br/>[PutUDP](docs/PROCESSORS.md#putudp)<br/>[ReplaceText](docs/PROCESSORS.md#replacetext)<br/>[RetryFlowFile](docs/PROCESSORS.md#retryflowfile)<br/>[RouteOnAttribute](docs/PROCESSORS.md#routeonattribute)<br/>[RouteText](docs/PROCESSORS.md#routetext)<br/>[SegmentContent](docs/PROCESSORS.md#segmentcontent)<br/>[SplitContent](docs/PROCESSORS.md#splitcontent)<br/>[SplitText](docs/PROCESSORS.md#splittext)<br/>[TailFile](docs/PROCESSORS.md#tailfile)<br/>[UpdateAttribute](docs/PROCESSORS.md#updateattribute) |
...
|----------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------------------|
| Archive Extensions               | [ApplyTemplate](docs/PROCESSORS.md#applytemplate)<br/>[BinFiles](docs/PROCESSORS.md#binfiles)<br/>[CompressContent](docs/PROCESSORS.md#compresscontent)<br/>[ManipulateArchive](docs/PROCESSORS.md#manipulatearchive)<br/>[MergeContent](docs/PROCESSORS.md#mergecontent)<br/>[FocusArchiveEntry](docs/PROCESSORS.md#focusarchiveentry)<br/>[UnfocusArchiveEntry](docs/PROCESSORS.md#unfocusarchiveentry)                                                                                                                                                                                                                                                                                    | -DBUILD_LIBARCHIVE=ON        |
| AWS                              | [AWSCredentialsService](docs/CONTROLLERS.md#awscredentialsservice)<br/>[PutS3Object](docs/PROCESSORS.md#puts3object)<br/>[DeleteS3Object](docs/PROCESSORS.md#deletes3object)<br/>[FetchS3Object](docs/PROCESSORS.md#fetchs3object)<br/>[ListS3](docs/PROCESSORS.md#lists3)<br/>[PutKinesisStream](docs/PROCESSORS.md#putkinesisstream)                                                                                                                                                                                                                                                                                                                                                       | -DENABLE_AWS=ON              |
| Azure                            | [AzureStorageCredentialsService](docs/CONTROLLERS.md#azurestoragecredentialsservice)<br/>[PutAzureBlobStorage](docs/PROCESSORS.md#putazureblobstorage)<br/>[DeleteAzureBlobStorage](docs/PROCESSORS.md#deleteazureblobstorage)<br/>[FetchAzureBlobStorage](docs/PROCESSORS.md#fetchazureblobstorage)<br/>[ListAzureBlobStorage](docs/PROCESSORS.md#listazureblobstorage)<br/>[PutAzureDataLakeStorage](docs/PROCESSORS.md#putazuredatalakestorage)<br/>[DeleteAzureDataLakeStorage](docs/PROCESSORS.md#deleteazuredatalakestorage)<br/>[FetchAzureDataLakeStorage](docs/PROCESSORS.md#fetchazuredatalakestorage)<br/>[ListAzureDataLakeStorage](docs/PROCESSORS.md#listazuredatalakestorage) | -DENABLE_AZURE=ON            |
| CivetWeb                         | [ListenHTTP](docs/PROCESSORS.md#listenhttp)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | -DENABLE_CIVET=ON            |
| Couchbase                        | [CouchbaseClusterService](docs/CONTROLLERS.md#couchbaseclusterservice)<br/>[PutCouchbaseKey](docs/PROCESSORS.md#putcouchbasekey)<br/>[GetCouchbaseKey](docs/PROCESSORS.md#getcouchbasekey)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | -DENABLE_COUCHBASE=ON        |
| Elasticsearch                    | [ElasticsearchCredentialsControllerService](docs/CONTROLLERS.md#elasticsearchcredentialscontrollerservice)<br/>[PostElasticsearch](docs/PROCESSORS.md#postelasticsearch)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | -DENABLE_ELASTICSEARCH=ON    |
| ExecuteProcess (Linux and macOS) | [ExecuteProcess](docs/PROCESSORS.md#executeprocess)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | -DENABLE_EXECUTE_PROCESS=ON  |
| Google Cloud Platform            | [DeleteGCSObject](docs/PROCESSORS.md#deletegcsobject)<br>[FetchGCSObject](docs/PROCESSORS.md#fetchgcsobject)<br>[GCPCredentialsControllerService](docs/CONTROLLERS.md#gcpcredentialscontrollerservice)<br>[ListGCSBucket](docs/PROCESSORS.md#listgcsbucket)<br>[PutGCSObject](docs/PROCESSORS.md#putgcsobject)                                                                                                                                                                                                                                                                                                                                                                               | -DENABLE_GCP=ON              |
| Grafana Loki                     | [PushGrafanaLokiREST](docs/PROCESSORS.md#pushgrafanalokirest)<br>[PushGrafanaLokiGrpc](docs/PROCESSORS.md#pushgrafanalokigrpc)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | -DENABLE_GRAFANA_LOKI=ON     |
| Kafka                            | [PublishKafka](docs/PROCESSORS.md#publishkafka)<br>[ConsumeKafka](docs/PROCESSORS.md#consumekafka)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | -DENABLE_KAFKA=ON            |
| Kubernetes (Linux)               | [KubernetesControllerService](docs/CONTROLLERS.md#kubernetescontrollerservice)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | -DENABLE_KUBERNETES=ON       |
| LlamaCpp                         | [RunLlamaCppInference](docs/PROCESSORS.md#runllamacppinference)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | -DENABLE_LLAMACPP=ON         |
| Lua Scripting                    | [ExecuteScript](docs/PROCESSORS.md#executescript)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | -DENABLE_LUA_SCRIPTING=ON    |
| MQTT                             | [ConsumeMQTT](docs/PROCESSORS.md#consumemqtt)<br/>[PublishMQTT](docs/PROCESSORS.md#publishmqtt)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | -DENABLE_MQTT=ON             |
| OPC                              | [FetchOPCProcessor](docs/PROCESSORS.md#fetchopcprocessor)<br/>[PutOPCProcessor](docs/PROCESSORS.md#putopcprocessor)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | -DENABLE_OPC=ON              |
| OpenCV                           | [CaptureRTSPFrame](docs/PROCESSORS.md#capturertspframe)<br/>[MotionDetector](docs/PROCESSORS.md#motiondetector)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | -DENABLE_OPENCV=ON           |
| PDH (Windows)                    | [PerformanceDataMonitor](docs/PROCESSORS.md#performancedatamonitor)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | -DENABLE_PDH=ON              |
| ProcFs (Linux)                   | [ProcFsMonitor](docs/PROCESSORS.md#procfsmonitor)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | -DENABLE_PROCFS=ON           |
| Python Scripting                 | [ExecuteScript](docs/PROCESSORS.md#executescript)<br/>[**Custom Python Processors**](extensions/python/PYTHON.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | -DENABLE_PYTHON_SCRIPTING=ON |
| SMB (Windows)                    | [FetchSmb](docs/PROCESSORS.md#fetchsmb)<br/>[ListSmb](docs/PROCESSORS.md#listsmb)<br/>[PutSmb](docs/PROCESSORS.md#putsmb)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | -DENABLE_SMB=ON              |
| SFTP                             | [FetchSFTP](docs/PROCESSORS.md#fetchsftp)<br/>[ListSFTP](docs/PROCESSORS.md#listsftp)<br/>[PutSFTP](docs/PROCESSORS.md#putsftp)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | -DENABLE_SFTP=ON             |
| SQL                              | [ExecuteSQL](docs/PROCESSORS.md#executesql)<br/>[PutSQL](docs/PROCESSORS.md#putsql)<br/>[QueryDatabaseTable](docs/PROCESSORS.md#querydatabasetable)<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | -DENABLE_SQL=ON              |
| Splunk                           | [PutSplunkHTTP](docs/PROCESSORS.md#putsplunkhttp)<br/>[QuerySplunkIndexingStatus](docs/PROCESSORS.md#querysplunkindexingstatus)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | -DENABLE_SPLUNK=ON           |
| Systemd (Linux)                  | [ConsumeJournald](docs/PROCESSORS.md#consumejournald)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | -DENABLE_SYSTEMD=ON          |
| Windows Event Log (Windows)      | [ConsumeWindowsEventLog](docs/PROCESSORS.md#consumewindowseventlog)<br/>[TailEventLog](docs/PROCESSORS.md#taileventlog)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | -DENABLE_WEL=ON              |
...
Communicating with Apache NiFi can be done using the Site-to-Site protocol. More information on configuring it in MiNiFi C++ can be found in the [Site-to-Site documentation](docs/SITE_TO_SITE.md).
...
#### Windows
  ...
  msi file. See [Windows.md](docs/Windows.md) for more details.
...
- Perform a `cmake ..` to generate the project files
  - Optionally disable or enable extensions. Please visit our guide [extensions guide](docs/Extensions.md) for flags or our wiki entry on
...
### Configuring
The 'conf' directory in the installation root contains a template config.yml document, minifi.properties, and minifi-log.properties. Please see our [Configuration document](docs/CONFIGURE.md) for details on how to configure agents.
...
The query can look like the following: "processor:TailFile:health,stats,bulletins". For more information on the query syntax and options, please see the [flow status documentation](docs/OPS.md#Flowstatus-command).
...
Please see [Extensions.md](docs/Extensions.md) on how to build and run conditionally built dependencies and extensions.
...
## Operations
See our [operations documentation for additional information on how to manage instances](docs/OPS.md)

## Monitoring
See our [metrics documentation for information about self published metrics](docs/METRICS.md)
