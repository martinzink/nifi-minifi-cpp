...
class ProcessContextImpl : public core::VariableRegistryImpl, public virtual ProcessContext {
 public:
   ...
   * <code>false</code>
   */
  bool isControllerServiceEnabled(const std::string& identifier) override { return controller_service_provider_->isControllerServiceEnabled(identifier); }
   ...
   */
  bool isControllerServiceEnabling(const std::string& identifier) override { return controller_service_provider_->isControllerServiceEnabling(identifier); }
   ...
   */
  const std::string getControllerServiceName(const std::string& identifier) const override { return controller_service_provider_->getControllerServiceName(identifier); }
