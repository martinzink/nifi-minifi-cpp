...
class MockProcessContext : public api::core::ProcessContext {
 public:
  ...
  [[nodiscard]] nonstd::expected<std::string, std::error_code> getProperty(const core::PropertyReference& property_reference,
  ...
  [[nodiscard]] nonstd::expected<api::utils::net::SslData, std::error_code> getSslData(std::string_view name) const override;
