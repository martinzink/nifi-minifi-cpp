...
MinifiExtension* MINIFI_CREATE_EXTENSION_FN(MinifiExtensionContext*, const MinifiExtensionCreateInfo*) {
...
MinifiStatus MinifiProcessContextGetSslContextService(MinifiProcessContext*, MinifiStringView,
    MinifiSslContextService**) {
  throw std::runtime_error("Not implemented");
}

MinifiStatus MinifiSslContextServiceGetCertificateFile(MinifiSslContextService*, void (*)(void* user_ctx, MinifiStringView certificate_file), void*) {
  throw std::runtime_error("Not implemented");
}

MinifiStatus MinifiSslContextServiceGetPassphrase(MinifiSslContextService*, void (*)(void* user_ctx, MinifiStringView passphrase), void*) {
  throw std::runtime_error("Not implemented");
}

MinifiStatus MinifiSslContextServiceGetPrivateKeyFile(MinifiSslContextService*, void (*)(void* user_ctx, MinifiStringView private_key_file), void*) {
  throw std::runtime_error("Not implemented");
}

MinifiStatus MinifiSslContextServiceGetCACertificate(MinifiSslContextService*, void (*)(void* user_ctx, MinifiStringView ca_certificate), void*) {
  throw std::runtime_error("Not implemented");
}
