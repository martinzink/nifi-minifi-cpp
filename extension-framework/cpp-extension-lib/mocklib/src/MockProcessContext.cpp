...
nonstd::expected<std::string, std::error_code> MockProcessContext::getProperty(const std::string_view name, const api::core::FlowFile*) const {
...
nonstd::expected<MinifiControllerService*, std::error_code> MockProcessContext::getControllerService(std::string_view, std::string_view) const {
  return nullptr;
}
...
nonstd::expected<api::utils::net::SslData, std::error_code> MockProcessContext::getSslData(std::string_view) const {
