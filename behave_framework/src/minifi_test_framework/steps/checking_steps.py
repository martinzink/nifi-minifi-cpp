...
def step_impl(context: MinifiTestContext, content: str, directory: str, duration: str):
    ...
    assert wait_for_condition(
        ...
        timeout_seconds=timeout_in_seconds, bail_condition=lambda: context.minifi_container.exited) or context.minifi_container.log_app_output()
...
def step_impl(context: MinifiTestContext, message: str, duration: str):
    ...
    assert message not in context.minifi_container.get_logs() or context.minifi_container.log_app_output()
...
def step_impl(context: MinifiTestContext, message: str, duration: str):
    ...
    assert wait_for_condition(condition=lambda: message in context.minifi_container.get_logs(),
                              timeout_seconds=duration_seconds, bail_condition=lambda: context.minifi_container.exited) or context.minifi_container.log_app_output()
