...
class MinifiLinuxContainer(LinuxContainer, MinifiProtocol):
    def __init__(self, container_name: str, test_context: MinifiTestContext, deployment: NormalDeployment | FHSDeployment):
        ...
        self.controller = MinifiController(self, f"{self.deployment_type.conf_path}/conf/config.yml", self.deployment_type.bin_path)
        ...
        self.files.append(File("/tmp/resources/minifi_merged_cert.crt", dump_cert(minifi_client_cert) + dump_key(minifi_client_key)))
    ...
    def deploy(self, context: MinifiTestContext | None) -> bool:
        ...
        self.files.append(File(f"{self.deployment_type.conf_path}/minifi.properties", self._get_properties_file_content()))
        self.files.append(File(f"{self.deployment_type.conf_path}/minifi-log.properties", self._get_log_properties_file_content()))
