...
Feature: Minifi C++ can act as a modbus tcp master
  ...
  Scenario: MiNiFi can fetch data from a modbus slave
    ...
    And PLC register has been set with h@5678/f=3.14 command
    ...
    Then a flowfile with the JSON content "{"foo":"123","bar":"3.14","baz":"M, i, N, i, F, i"}" is placed in the monitored directory in less than 10 seconds
