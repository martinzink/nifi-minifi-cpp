...
BEHAVE_OPTS=(--logging-level INFO --parallel-processes "${_arg_parallel_processes}" --parallel-scheme feature --show-progress-bar -o "${PWD}/behavex_output" -t "${_arg_tags_to_run}")
