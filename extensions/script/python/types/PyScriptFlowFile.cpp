...
static PyType_Slot PyScriptFlowFileTypeSpecSlots[] = {
    {Py_tp_dealloc, reinterpret_cast<void*>(PyScriptFlowFile::dealloc)},
    {Py_tp_init, reinterpret_cast<void*>(PyScriptFlowFile::init)},
    {Py_tp_methods, reinterpret_cast<void*>(PyScriptFlowFile_methods)},
    {Py_tp_new, reinterpret_cast<void*>(PyScriptFlowFile::newInstance)},
    {}  /* Sentinel */
};
...
PyObject* PyScriptFlowFile::newInstance(PyTypeObject* type, PyObject*, PyObject*) {
