...
static PyType_Slot PyProcessorTypeSpecSlots[] = {
    {Py_tp_dealloc, reinterpret_cast<void*>(PyProcessor::dealloc)},
    {Py_tp_init, reinterpret_cast<void*>(PyProcessor::init)},
    {Py_tp_methods, reinterpret_cast<void*>(PyProcessor_methods)},
    {Py_tp_new, reinterpret_cast<void*>(PyProcessor::newInstance)},
    {}  /* Sentinel */
};
...
PyObject* PyProcessor::newInstance(PyTypeObject* type, PyObject*, PyObject*) {
  auto self = reinterpret_cast<PyProcessor*>(PyType_GenericAlloc(type, 0));
  if (self == nullptr) {
    return nullptr;
  }
