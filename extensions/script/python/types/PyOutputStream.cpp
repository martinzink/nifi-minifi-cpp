...
static PyType_Slot PyOutputStreamTypeSpecSlots[] = {
    {Py_tp_dealloc, reinterpret_cast<void*>(PyOutputStream::dealloc)},
    {Py_tp_init, reinterpret_cast<void*>(PyOutputStream::init)},
    {Py_tp_methods, reinterpret_cast<void*>(PyOutputStream_methods)},
    {Py_tp_new, reinterpret_cast<void*>(PyOutputStream::newInstance)},
    {}  /* Sentinel */
};
...
PyObject* PyOutputStream::newInstance(PyTypeObject* type, PyObject*, PyObject*) {
  auto self = reinterpret_cast<PyOutputStream*>(PyType_GenericAlloc(type, 0));
  if (self == nullptr) {
    return nullptr;
  }
