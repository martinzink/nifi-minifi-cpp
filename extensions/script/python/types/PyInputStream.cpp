...
static PyType_Slot PyInputStreamTypeSpecSlots[] = {
    {Py_tp_dealloc, reinterpret_cast<void*>(PyInputStream::dealloc)},
    {Py_tp_init, reinterpret_cast<void*>(PyInputStream::init)},
    {Py_tp_methods, reinterpret_cast<void*>(PyInputStream_methods)},
    {Py_tp_new, reinterpret_cast<void*>(PyInputStream::newInstance)},
    {}  /* Sentinel */
};
...
PyObject* PyInputStream::newInstance(PyTypeObject* type, PyObject*, PyObject*) {
  auto self = reinterpret_cast<PyInputStream*>(PyType_GenericAlloc(type, 0));
  if (self == nullptr) {
    return nullptr;
  }
