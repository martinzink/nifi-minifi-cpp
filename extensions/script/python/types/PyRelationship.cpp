...
static PyType_Slot PyRelationshipTypeSpecSlots[] = {
    {Py_tp_dealloc, reinterpret_cast<void*>(PyRelationship::dealloc)},
    {Py_tp_init, reinterpret_cast<void*>(PyRelationship::init)},
    {Py_tp_methods, reinterpret_cast<void*>(PyRelationship_methods)},
    {Py_tp_new, reinterpret_cast<void*>(PyRelationship::newInstance)},
    {}  /* Sentinel */
};
...
PyObject* PyRelationship::newInstance(PyTypeObject* type, PyObject*, PyObject*) {
  auto self = reinterpret_cast<PyScriptFlowFile*>(PyType_GenericAlloc(type, 0));
  if (self == nullptr) {
    return nullptr;
  }
...
void PyRelationship::dealloc(PyRelationship*) {
}
