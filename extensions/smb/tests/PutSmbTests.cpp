...
TEST_CASE("PutSmb conflict resolution test") {
  ...
  SECTION("Replace") {
    controller.plan->setProperty(put_smb, PutSmb::ConflictResolution, toString(put_smb::FileExistsResolutionStrategy::REPLACE_FILE));
  ...
  SECTION("Ignore") {
    controller.plan->setProperty(put_smb, PutSmb::ConflictResolution, toString(put_smb::FileExistsResolutionStrategy::IGNORE_REQUEST));
  ...
  SECTION("Fail") {
    controller.plan->setProperty(put_smb, PutSmb::ConflictResolution, toString(put_smb::FileExistsResolutionStrategy::FAIL_FLOW));
