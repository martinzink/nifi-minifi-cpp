...
class PutSmb : public core::Processor {
 public:
  ...
  EXTENSIONAPI static constexpr auto ConnectionControllerService = core::PropertyDefinitionBuilder<>::createProperty("SMB Connection Controller Service")
      ...
      .isRequired(true)
      .withAllowedTypes({core::className<SmbConnectionControllerService>()})
      .build();
  ...
  EXTENSIONAPI static constexpr auto ConflictResolution = core::PropertyDefinitionBuilder<3>::createProperty("Conflict Resolution Strategy")
      ...
      .withDefaultValue(toStringView(put_smb::FileExistsResolutionStrategy::FAIL_FLOW))
      .withAllowedValues(put_smb::FileExistsResolutionStrategy::values)
      .build();
 ...
 private:
  ...
  put_smb::FileExistsResolutionStrategy conflict_resolution_strategy_ = put_smb::FileExistsResolutionStrategy::FAIL_FLOW;
