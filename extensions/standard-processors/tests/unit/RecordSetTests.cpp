...
TEST_CASE("Test JSON serialization of a RecordField") {
  ...
  }
  {
    ...
    obj.emplace("key1", std::unique_ptr<core::RecordField, core::BoxedRecordField::RecordFieldDeleter>{new minifi::core::RecordField(1)});
    obj.emplace("key2", std::unique_ptr<core::RecordField, core::BoxedRecordField::RecordFieldDeleter>{new core::RecordField(std::string("hello"))});
...
TEST_CASE("Test JSON serialization of a Record") {
  ...
  subobj.emplace("subkey3", std::unique_ptr<core::RecordField, core::BoxedRecordField::RecordFieldDeleter>{new core::RecordField(1)});
  subobj.emplace("subkey4", std::unique_ptr<core::RecordField, core::BoxedRecordField::RecordFieldDeleter>{new core::RecordField(std::string("subhello"))});
  minifi::core::RecordObject obj;
  obj.emplace("subkey1", std::unique_ptr<core::RecordField, core::BoxedRecordField::RecordFieldDeleter>{new core::RecordField(-2)});
  obj.emplace("subkey2", std::unique_ptr<core::RecordField, core::BoxedRecordField::RecordFieldDeleter>{new core::RecordField(std::move(subobj))});
  ...
  std::string json_str = R"(
{
  ...
  minifi::core::RecordObject subobj;
  subobj.emplace("number2", std::unique_ptr<core::RecordField, core::BoxedRecordField::RecordFieldDeleter>{new core::RecordField(2)});
  subobj.emplace("message", std::unique_ptr<core::RecordField, core::BoxedRecordField::RecordFieldDeleter>{new core::RecordField(std::string("mymessage"))});
