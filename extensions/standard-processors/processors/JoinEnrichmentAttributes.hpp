...
class JoinEnrichmentAttributes : public core::ProcessorImpl {
 public:
  ...
  EXTENSIONAPI static constexpr auto Properties = std::array<core::PropertyReference, 1>{TimeoutProperty};
 ...
 private:
  ...
  void join(const std::shared_ptr<core::FlowFile>& original, const std::shared_ptr<core::FlowFile>& enrichment, core::ProcessSession& session,
