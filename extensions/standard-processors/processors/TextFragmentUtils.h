...
namespace org::apache::nifi::minifi::processors::textfragmentutils {
  constexpr std::string_view BASE_NAME_ATTRIBUTE = "TextFragmentAttribute.base_name";
  constexpr std::string_view POST_NAME_ATTRIBUTE = "TextFragmentAttribute.post_name";
  constexpr std::string_view OFFSET_ATTRIBUTE = "TextFragmentAttribute.offset";
