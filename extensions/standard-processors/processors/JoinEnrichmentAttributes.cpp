...
void JoinEnrichmentAttributes::join(const std::shared_ptr<core::FlowFile>& one, const std::shared_ptr<core::FlowFile>& two,
...
void JoinEnrichmentAttributes::handleFlowFile(std::shared_ptr<core::FlowFile> flow_file, core::ProcessSession& session,
  ...
  /// SAFETY: we checked that the required attributes are present in checkRequiredAttributes
