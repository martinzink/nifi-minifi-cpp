...
TEST_CASE("HTTPTestsWithNoResourceClaimPOST", "[httptest1]") {
  ...
  invokehttp->onSchedule_2(context, factory2);
  invokehttp->onTrigger_2(context, session);
...
TEST_CASE("HTTPTestsWithResourceClaimPOST", "[httptest1]") {
  ...
  invokehttp->onSchedule_2(context2, factory2);
  invokehttp->onTrigger_2(context2, session2);

  listenhttp->incrementActiveTasks();
  listenhttp->setScheduledState(core::ScheduledState::RUNNING);
  listenhttp->onSchedule_2(context, factory);
  listenhttp->onTrigger_2(context, session);
